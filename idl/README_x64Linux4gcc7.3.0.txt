...
data type HelloWorld from HelloWorld.idl.
This example builds two applications, named HelloWorld_publisher and
...
> make -f makefile_HelloWorld_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the HelloWorld_publisher.cxx
file where it says:
...
Run /home/qiliang/rti_connext_dds-6.1.1/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/HelloWorld_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/HelloWorld_subscriber -d <domain_id> -s <sample_count>
